...
class VersionRange {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$start, $minus, $end] = generated_1.ast_internal.selectSequence(this.cst);
            return {
...
class VersionTerm {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$operator, $literal] = generated_1.ast_internal.selectSequence(this.cst);
            return {
                operator: $operator === null ? undefined : new VersionOperator($operator),
                literal: new VersionLiteral($literal),
            };
        });
        assertKind(this.cst.kind, kinds_1.NonterminalKind.VersionTerm);
    }
    get operator() {
...
exports.VersionTerm = VersionTerm;
...
class YulVariableDeclarationStatement {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$letKeyword, $variables, $value] = generated_1.ast_internal.selectSequence(this.cst);
            return {
...
class YulVariableAssignmentStatement {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$variables, $assignment, $expression] = generated_1.ast_internal.selectSequence(this.cst);
            return {
...
class YulColonAndEqual {
    constructor(cst) {
        ...
        assertKind(this.cst.kind, kinds_1.NonterminalKind.YulColonAndEqual);
    }
    get colon() {
        return this.fetch().colon;
    }
...
exports.YulColonAndEqual = YulColonAndEqual;
class YulStackAssignmentStatement {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$assignment, $variable] = generated_1.ast_internal.selectSequence(this.cst);
            return {
...
class YulEqualAndColon {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
            const [$equal, $colon] = generated_1.ast_internal.selectSequence(this.cst);
            return {
                equal: $equal,
                colon: $colon,
            };
        });
        assertKind(this.cst.kind, kinds_1.NonterminalKind.YulEqualAndColon);
    }
    get equal() {
        return this.fetch().equal;
    }
...
exports.YulEqualAndColon = YulEqualAndColon;
    ...
    constructor(cst) {
        ...
        this.fetch = once(() => {
            ...
            switch (variant.kind) {
                ...
                case kinds_1.NonterminalKind.VersionTerm:
...
class VersionOperator {
    constructor(cst) {
        ...
        assertKind(this.cst.kind, kinds_1.NonterminalKind.VersionOperator);
    }
    get variant() {
        return this.fetch();
    }
}
exports.VersionOperator = VersionOperator;
class VersionLiteral {
    constructor(cst) {
        ...
        this.fetch = once(() => {
            ...
            switch (variant.kind) {
                case kinds_1.NonterminalKind.SimpleVersionLiteral:
                    return new SimpleVersionLiteral(variant);
                default:
                    assert.fail(`Unexpected variant: ${variant.kind}`);
            }
        });
        assertKind(this.cst.kind, kinds_1.NonterminalKind.VersionLiteral);
    }
    get variant() {
        return this.fetch();
    }
...
class YulAssignmentOperator {
    constructor(cst) {
        ...
        this.fetch = once(() => {
            ...
            switch (variant.kind) {
                case kinds_1.NonterminalKind.YulColonAndEqual:
...
class YulStackAssignmentOperator {
    constructor(cst) {
        ...
        this.fetch = once(() => {
            ...
            switch (variant.kind) {
                case kinds_1.NonterminalKind.YulEqualAndColon:
                    return new YulEqualAndColon(variant);
                default:
                    assert.fail(`Unexpected variant: ${variant.kind}`);
            }
        });
        assertKind(this.cst.kind, kinds_1.NonterminalKind.YulStackAssignmentOperator);
    }
    get variant() {
        return this.fetch();
    }
}
exports.YulStackAssignmentOperator = YulStackAssignmentOperator;
class YulSwitchCase {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
...
class SimpleVersionLiteral {
    constructor(cst) {
        ...
        assertKind(this.cst.kind, kinds_1.NonterminalKind.SimpleVersionLiteral);
    }
    get items() {
        return this.fetch().items;
    }
...
exports.SimpleVersionLiteral = SimpleVersionLiteral;
...
class YulVariableNames {
    constructor(cst) {
        ...
        assertKind(this.cst.kind, kinds_1.NonterminalKind.YulVariableNames);
    }
    get items() {
        return this.fetch().items;
    }
...
exports.YulVariableNames = YulVariableNames;
class YulArguments {
    constructor(cst) {
        this.cst = cst;
        this.fetch = once(() => {
